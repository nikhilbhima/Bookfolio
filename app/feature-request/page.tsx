      ...
      <div className="flex-1 py-12 px-4">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-muted-foreground">
            <p className="text-lg">We love hearing from our users! Your feedback helps us build a better Bookfolio for everyone.</p>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Have an idea?</h2>
            <p>If you have a feature request, suggestion, or just want to share your thoughts about Bookfolio, we&apos;d love to hear from you!</p>
            ...
            <p className="mt-6">Thank you for helping us make Bookfolio better! 📚</p>
          </div>
        </div>
      </div>
